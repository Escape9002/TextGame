...
public class Game {
	...
	public static void main(String[] args) {
		...
		//for (int i = 0; i < rounds; i++) {
			...
			//while(enemie.getHealth() < 0){
				if (player.choice() == 1) {
					enemie.receiveDmg(player.doDMG());
					System.out.println("You attack him! Health left: " + enemie.getHealth());
			...
			System.out.println(mage.Events(3));

			if (player.choice() == 1) {
				System.out.println(enemie.Events(4));
				// FuckYourTimeManagement(1);
			} else if (player.choice() == 2) {
				System.out.println(enemie.Events(5));
				// FuckYourTimeManagement(1);
			}
		//}
	}
